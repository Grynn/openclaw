...
const SKILL_CATALOG_TOOL_NAME = "skill_catalog";
const SKILL_CATALOG_DEFAULT_SEARCH_LIMIT = 10;
const SKILL_CATALOG_MAX_SEARCH_LIMIT = 25;
const SKILL_CATALOG_MAX_QUERY_CHARS = 512;
const SKILL_CATALOG_MAX_PAGE_BYTES = 12_000;
const SKILL_CATALOG_MAX_FILE_BYTES = DEFAULT_MAX_SKILL_FILE_BYTES;
const SKILL_CATALOG_MAX_OUTPUT_BYTES = 32_000;
const SKILL_CATALOG_MAX_RESOURCE_ENTRIES = 2_000;
const SKILL_CATALOG_MAX_RESOURCE_PATH_CHARS = 512;

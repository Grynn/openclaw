    ...
    return {
      ...
      onFailed: async (error) => {
        ...
        try {
          ...
          // A watchdog release would repeat the same failed retry disposition.
          // Preserve recovery by switching that later watchdog action to the
          // terminal queue write, matching the pre-rebase gateway behavior.
          state.forceStallDeadLetter = true;

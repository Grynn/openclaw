...
function isDurablyConsumedQueuedSource(
  ...
  // Stored queue sources remain provider-granular. Synthetic aggregates cross directly
  // into runFollowup; collect and overflow retries restore their original sources.
  const sourceTurnIds = [
